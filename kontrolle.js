...
window.RB.kontrolle = {
  ...
  buttons: {
    fahrer: [
      ...
      ["aufnahme-filmen-stoppen", "Filmen aufhören", "Прекратить съёмку", ["filmen", "sie filmen", "aufnehm", "aufnahme", "ihre kamera", "kamera aus", "video aus", "handy runter", "handy weg", "smartphone weg", "fotografier", "keine fotos", "lösch", "снимать", "съёмк", "запись ", "удал", "прекратите сним", "опустите телефон"]],
      ["fahrer-unterschrift", "Unterschreiben", "Подписать", ["unterschreib", "unterschrift", "подпис", "подпиш"]]
    ],
    beifahrer: [
      ["person-beifahrer-ausweis", "Ausweis vom Beifahrer", "Документ пассажира", ["ausweis", "personalausweis", "personalien", "ausweisen", "wie heißen sie", "документ", "паспорт", "удостоверени"]],
      ["druck-zeuge-beifahrer", "Aussagen als Zeuge", "Показания свидетеля", ["zeuge", "aussage", "aussagen", "gefahren", "getrunken", "свидетел", "показани", "за рулём", "пил"]],
      ...
      ["druck-unterschreiben", "Unterschreiben", "Подписать", ["unterschreib", "unterschrift", "подпис", "подпиш"]],
  ...
  kurz: {
    ...
    "fahrer-handy": { de: "Zum Vorwurf sage ich nichts. Mein Handy entsperre ich nicht, den Code nenne ich nicht.", ru: "По обвинению ничего не скажу. Телефон не разблокирую, код не назову.", law: "§ 136 Abs. 1 S. 2 StPO",
      dann: "Beschlagnahmt er es: keinen Widerstand leisten.", dann_ru: "Если изымает: не сопротивляться." },
    ...
    "person-handy": { de: "Ich gebe das Handy nicht freiwillig heraus und widerspreche der Beschlagnahme. Meinen PIN nenne ich nicht.", ru: "Телефон добровольно не отдаю и возражаю против изъятия. PIN не называю.", law: "§ 98 Abs. 2 · § 136 Abs. 1 S. 2 StPO",
      dann: "Nimmt er es trotzdem: keinen Widerstand leisten, Bescheinigung verlangen.", dann_ru: "Если всё равно забирает: не сопротивляться, потребовать справку." },
